...
def test_query5():
    ...
    assert result["collection"] == "quran"
    assert result["query"]["filters"][0]["name"] == "ayah"
    assert result["query"]["filters"][0]["number"] == 1
    assert result["query"]["filters"][1]["name"] == "surah"
    assert result["query"]["filters"][1]["number"] == 2
